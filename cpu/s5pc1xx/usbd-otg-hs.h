...
#if 1
#define S3C_USBD_DETECT_IRQ()	(readl(0xED200000 + 0x014) & 0x800c3810)
#define S3C_USBD_CLEAR_IRQ()	do { \
					writel(BIT_ALLMSK, (0xED200000+0x014)); \
				} while (0)
#else
#define S3C_USBD_DETECT_IRQ()	(readl(0xE4100008) & (1<<26))
#define S3C_USBD_CLEAR_IRQ()	do { \
					writel((1<<26), 0xE4100008); \
				} while (0)
#endif
